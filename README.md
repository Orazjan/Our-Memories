...
Single Activity (Fragments), MVVM-like patterns
...
Партнер получает пуш: "Новое воспоминание! 📸"
...
Узнайте, что партнер освободился: "Новый статус! 👀"

Записка

"Записка на холодильнике 📝" (защита от дубликатов для автора)
...
Подключите свой проект Firebase:
...
(Опционально) Для работы уведомлений разверните Cloud Functions:
...
Если у вас есть идеи или предложения, пишите на support@ourmemories.com.
