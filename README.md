...
<div align="center">"Любовь состоит не в том, чтобы смотреть друг на друга, </div>
<div align="center" а в том, чтобы смотреть в одном направлении."</div>
...
* 💭 Живые статусы: Устанавливайте эмодзи-статус (😴, 💼, ❤️) или пишите свой текст, чтобы партнер
  знал, чем вы заняты.
...
| **Backend (BaaS)** | **Firebase**<br>• **Authentication**: Вход через Email<br>• **Firestore**: База данных реального времени (NoSQL)<br>• **Storage**: Хранение фотографий и аватарок<br>• **Cloud Functions**: Серверная логика (Node.js)<br>• **Cloud Messaging (FCM)**: Push-уведомления |
| **Библиотеки** | • **Glide**: Загрузка и кэширование изображений<br>• **PhotoView**: Просмотр изображений с жестами зума<br>• **Material Design Components**: Современный UI/UX |
...
| Событие           | Уведомление                                                    |
|:------------------|:---------------------------------------------------------------|
| **Новое фото**    | Партнер получает пуш: "Новое воспоминание! 📸"                 |
| **Новое желание** | Уведомление: "Новое желание! ✨"                                |
| **Смена статуса** | Узнайте, что партнер освободился: "Новый статус! 👀"           |
| **Записка**       | "Записка на холодильнике 📝" (защита от дубликатов для автора) |
| **Связь**         | Уведомление при успешном соединении аккаунтов.                 |
...
1) Клонируйте репозиторий:
        ...
        git clone https://github.com/Orazjan/Our-Memories.git
